...
ABACATEPAY_API_BASE_URL = os.getenv("ABACATEPAY_API_BASE_URL", "https://api.abacatepay.com/v2").rstrip("/")
ABACATEPAY_WEBHOOK_SECRET = os.getenv("ABACATEPAY_WEBHOOK_SECRET", "")
ABACATEPAY_ALLOW_SIMULATION = env_bool("ABACATEPAY_ALLOW_SIMULATION", False)
BILLING_GRACE_PERIOD_DAYS = env_int("BILLING_GRACE_PERIOD_DAYS", 7)
BILLING_DUE_SOON_DAYS = env_int("BILLING_DUE_SOON_DAYS", 7)
BILLING_SUSPENSION_WARNING_DAYS = env_int("BILLING_SUSPENSION_WARNING_DAYS", 2)
